...
import org.cypher.core.config.Parameter.ForkBlockVersionEnum;
...
//      }
  ...
  public enum ProposalType {         // current value, value range
    ...
    ACCOUNT_UPGRADE_COST(1), // 9999 CYP, [0, 100000000000] CYP
    CREATE_ACCOUNT_FEE(2), // 0.1 CYP, [0, 100000000000] CYP
    TRANSACTION_FEE(3), // 10 Sun/Byte, [0, 100000000000] CYP
    ASSET_ISSUE_FEE(4), // 1024 CYP, [0, 100000000000] CYP
    WITNESS_PAY_PER_BLOCK(5), // 16 CYP, [0, 100000000000] CYP
    WITNESS_STANDBY_ALLOWANCE(6), // 115200 CYP, [0, 100000000000] CYP
    CREATE_NEW_ACCOUNT_FEE_IN_SYSTEM_CONTRACT(7), // 0 CYP, [0, 100000000000] CYP
    ...
    ENERGY_FEE(11), // 10 Sun, [0, 100000000000] CYP
    EXCHANGE_CREATE_FEE(12), // 1024 CYP, [0, 100000000000] CYP
    ...
    UPDATE_ACCOUNT_PERMISSION_FEE(22), // 100 CYP, [0, 100000] CYP
    MULTI_SIGN_FEE(23), // 1 CYP, [0, 100000] CYP
    ...
    MAX_FEE_LIMIT(47), // [0, 100_000_000_000] CYP
