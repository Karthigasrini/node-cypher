...
import static org.cypher.common.utils.WalletUtil.generateContractAddress;
...
public class ProgramInvokeFactory {
   ...
   */
  public static ProgramInvoke createProgramInvoke(InternalTransaction.CypType cypType,
    ...
    if (cypType == CYP_CONTRACT_CREATION_TYPE) {
    ...
    } else if (cypType == CYP_CONTRACT_CALL_TYPE) {
