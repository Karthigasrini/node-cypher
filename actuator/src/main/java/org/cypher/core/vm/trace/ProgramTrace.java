package org.cypher.core.vm.trace;

import static java.lang.String.format;
import static org.cypher.common.utils.ByteArray.toHexString;
import static org.cypher.core.vm.trace.Serializers.serializeFieldsOnly;
...
public class ProgramTrace {
  ...
  public ProgramTrace(ProgramInvoke programInvoke) {
    if (programInvoke != null && VMConfig.vmTrace()) {
      contractAddress = Hex.toHexString(programInvoke.getContractAddress().toCypherAddress());
    }
  }
