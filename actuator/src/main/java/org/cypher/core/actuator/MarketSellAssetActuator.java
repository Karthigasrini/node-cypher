...
import static org.cypher.core.actuator.ActuatorConstant.CONTRACT_NOT_EXIST;
import static org.cypher.core.actuator.ActuatorConstant.STORE_NOT_EXIST;
import static org.cypher.core.actuator.ActuatorConstant.TX_RESULT_NULL;
import static org.cypher.core.capsule.utils.TransactionUtil.isNumber;
...
import org.cypher.protos.Protocol.MarketOrder.State;
import org.cypher.protos.Protocol.MarketOrderDetail;
...
public class MarketSellAssetActuator extends AbstractActuator {
  ...
  private void matchSingleOrder(MarketOrderCapsule takerOrderCapsule,
    ...
    // for makerPrice,sellToken is A,buyToken is CYP.
    // for takerPrice,buyToken is A,sellToken is CYP.

    // makerSellTokenQuantity_A/makerBuyTokenQuantity_CYP =
    //   takerBuyTokenQuantityCurrent_A/takerSellTokenQuantityRemain_CYP
    // => takerBuyTokenQuantityCurrent_A = takerSellTokenQuantityRemain_CYP *
    //   makerSellTokenQuantity_A/makerBuyTokenQuantity_CYP
    ...
    if (takerBuyTokenQuantityRemain == makerOrderCapsule.getSellTokenQuantityRemain()) {
      ...
      // makerSellTokenQuantityRemain_A/makerBuyTokenQuantityCurrent_CYP =
      //   makerSellTokenQuantity_A/makerBuyTokenQuantity_CYP
      // => makerBuyTokenQuantityCurrent_CYP = makerSellTokenQuantityRemain_A *
      //   makerBuyTokenQuantity_CYP / makerSellTokenQuantity_A
    ...
    addCypOrToken(takerOrderCapsule, takerBuyTokenQuantityReceive, takerAccountCapsule);
    addCypOrToken(makerOrderCapsule, makerBuyTokenQuantityReceive);
  ...
  // for taker
  private void addCypOrToken(MarketOrderCapsule orderCapsule, long num,
