...
public final class DatabaseGrpc {
  ...
  public static final io.grpc.MethodDescriptor<org.cypher.api.GrpcAPI.EmptyMessage,
      org.cypher.api.GrpcAPI.BlockReference> METHOD_GET_BLOCK_REFERENCE = getGetBlockReferenceMethod();

  private static volatile io.grpc.MethodDescriptor<org.cypher.api.GrpcAPI.EmptyMessage,
      org.cypher.api.GrpcAPI.BlockReference> getGetBlockReferenceMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<org.cypher.api.GrpcAPI.EmptyMessage,
      org.cypher.api.GrpcAPI.BlockReference> getGetBlockReferenceMethod() {
    io.grpc.MethodDescriptor<org.cypher.api.GrpcAPI.EmptyMessage, org.cypher.api.GrpcAPI.BlockReference> getGetBlockReferenceMethod;
      ...
      synchronized (DatabaseGrpc.class) {
        if ((getGetBlockReferenceMethod = DatabaseGrpc.getGetBlockReferenceMethod) == null) {
          DatabaseGrpc.getGetBlockReferenceMethod = getGetBlockReferenceMethod = 
              io.grpc.MethodDescriptor.<org.cypher.api.GrpcAPI.EmptyMessage, org.cypher.api.GrpcAPI.BlockReference>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.cypher.api.GrpcAPI.BlockReference.getDefaultInstance()))
  ...
  public static final io.grpc.MethodDescriptor<org.cypher.api.GrpcAPI.EmptyMessage,
      org.cypher.protos.Protocol.DynamicProperties> METHOD_GET_DYNAMIC_PROPERTIES = getGetDynamicPropertiesMethod();

  private static volatile io.grpc.MethodDescriptor<org.cypher.api.GrpcAPI.EmptyMessage,
      org.cypher.protos.Protocol.DynamicProperties> getGetDynamicPropertiesMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<org.cypher.api.GrpcAPI.EmptyMessage,
      org.cypher.protos.Protocol.DynamicProperties> getGetDynamicPropertiesMethod() {
    io.grpc.MethodDescriptor<org.cypher.api.GrpcAPI.EmptyMessage, org.cypher.protos.Protocol.DynamicProperties> getGetDynamicPropertiesMethod;
      ...
      synchronized (DatabaseGrpc.class) {
        if ((getGetDynamicPropertiesMethod = DatabaseGrpc.getGetDynamicPropertiesMethod) == null) {
          DatabaseGrpc.getGetDynamicPropertiesMethod = getGetDynamicPropertiesMethod = 
              io.grpc.MethodDescriptor.<org.cypher.api.GrpcAPI.EmptyMessage, org.cypher.protos.Protocol.DynamicProperties>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.cypher.api.GrpcAPI.EmptyMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.cypher.protos.Protocol.DynamicProperties.getDefaultInstance()))
  ...
  public static abstract class DatabaseImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getDynamicProperties(org.cypher.api.GrpcAPI.EmptyMessage request,
        io.grpc.stub.StreamObserver<org.cypher.protos.Protocol.DynamicProperties> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                org.cypher.api.GrpcAPI.BlockReference>(
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                org.cypher.api.GrpcAPI.EmptyMessage,
                org.cypher.protos.Protocol.DynamicProperties>(
  ...
  public static final class DatabaseBlockingStub extends io.grpc.stub.AbstractStub<DatabaseBlockingStub> {
     ...
     * </pre>
     */
    public org.cypher.api.GrpcAPI.BlockReference getBlockReference(org.cypher.api.GrpcAPI.EmptyMessage request) {
    ...
    /**
     */
    public org.cypher.protos.Protocol.DynamicProperties getDynamicProperties(org.cypher.api.GrpcAPI.EmptyMessage request) {
      return blockingUnaryCall(
  ...
  public static final class DatabaseFutureStub extends io.grpc.stub.AbstractStub<DatabaseFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<org.cypher.api.GrpcAPI.BlockReference> getBlockReference(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.cypher.protos.Protocol.DynamicProperties> getDynamicProperties(
        org.cypher.api.GrpcAPI.EmptyMessage request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_BLOCK_REFERENCE:
          serviceImpl.getBlockReference((org.cypher.api.GrpcAPI.EmptyMessage) request,
              (io.grpc.stub.StreamObserver<org.cypher.api.GrpcAPI.BlockReference>) responseObserver);
          break;
        case METHODID_GET_DYNAMIC_PROPERTIES:
          serviceImpl.getDynamicProperties((org.cypher.api.GrpcAPI.EmptyMessage) request,
              (io.grpc.stub.StreamObserver<org.cypher.protos.Protocol.DynamicProperties>) responseObserver);
          break;
