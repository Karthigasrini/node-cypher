...
public final class MonitorGrpc {
  ...
  public static final io.grpc.MethodDescriptor<org.cypher.api.GrpcAPI.EmptyMessage,
      org.cypher.protos.Protocol.MetricsInfo> METHOD_GET_STATS_INFO = getGetStatsInfoMethod();

  private static volatile io.grpc.MethodDescriptor<org.cypher.api.GrpcAPI.EmptyMessage,
      org.cypher.protos.Protocol.MetricsInfo> getGetStatsInfoMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<org.cypher.api.GrpcAPI.EmptyMessage,
      org.cypher.protos.Protocol.MetricsInfo> getGetStatsInfoMethod() {
    io.grpc.MethodDescriptor<org.cypher.api.GrpcAPI.EmptyMessage, org.cypher.protos.Protocol.MetricsInfo> getGetStatsInfoMethod;
      ...
      synchronized (MonitorGrpc.class) {
        if ((getGetStatsInfoMethod = MonitorGrpc.getGetStatsInfoMethod) == null) {
          MonitorGrpc.getGetStatsInfoMethod = getGetStatsInfoMethod = 
              io.grpc.MethodDescriptor.<org.cypher.api.GrpcAPI.EmptyMessage, org.cypher.protos.Protocol.MetricsInfo>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.cypher.protos.Protocol.MetricsInfo.getDefaultInstance()))
  ...
  public static abstract class MonitorImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getStatsInfo(org.cypher.api.GrpcAPI.EmptyMessage request,
        io.grpc.stub.StreamObserver<org.cypher.protos.Protocol.MetricsInfo> responseObserver) {
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                org.cypher.protos.Protocol.MetricsInfo>(
  ...
  public static final class MonitorBlockingStub extends io.grpc.stub.AbstractStub<MonitorBlockingStub> {
    ...
    /**
     */
    public org.cypher.protos.Protocol.MetricsInfo getStatsInfo(org.cypher.api.GrpcAPI.EmptyMessage request) {
  ...
  public static final class MonitorFutureStub extends io.grpc.stub.AbstractStub<MonitorFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.cypher.protos.Protocol.MetricsInfo> getStatsInfo(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_STATS_INFO:
          serviceImpl.getStatsInfo((org.cypher.api.GrpcAPI.EmptyMessage) request,
              (io.grpc.stub.StreamObserver<org.cypher.protos.Protocol.MetricsInfo>) responseObserver);
          break;
        default:
