...
import org.cypher.core.services.http.solidity.SolidityNodeHttpApiService;
...
public class SolidityNode {
  ...
  public static void main(String[] args) {
    ...
    ApplicationContext context = new CypherApplicationContext(DefaultConfig.class);
    ...
    nodeManager.close();
    CypherNetService cypherNetService = context.getBean(CypherNetService.class);
