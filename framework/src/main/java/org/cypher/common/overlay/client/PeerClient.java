...
import org.cypher.common.overlay.server.CypherChannelInitializer;
...
public class PeerClient {
  ...
  public PeerClient() {
    workerGroup = new NioEventLoopGroup(0, new ThreadFactory() {
      ...
      public Thread newThread(Runnable r) {
        return new Thread(r, "CypherJClientWorker-" + cnt.getAndIncrement());
      }
    });
  }
  ...
  private ChannelFuture connectAsync(String host, int port, String remoteId,
    ...
    CypherChannelInitializer cypherChannelInitializer = ctx
        .getBean(CypherChannelInitializer.class, remoteId);
    cypherChannelInitializer.setPeerDiscoveryMode(discoveryMode);
    ...
    b.handler(cypherChannelInitializer);
