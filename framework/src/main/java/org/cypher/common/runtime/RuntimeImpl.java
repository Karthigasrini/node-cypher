...
import org.cypher.core.actuator.Actuator2;
...
import org.cypher.core.vm.program.Program.BadJumpDestinationException;
import org.cypher.core.vm.program.Program.IllegalOperationException;
...
import org.cypher.core.vm.program.Program.OutOfMemoryException;
import org.cypher.core.vm.program.Program.OutOfTimeException;
import org.cypher.core.vm.program.Program.PrecompiledContractException;
import org.cypher.core.vm.program.Program.StackTooLargeException;
import org.cypher.core.vm.program.Program.StackTooSmallException;
...
public class RuntimeImpl implements Runtime {
  ...
  public void execute(TransactionContext context)
    ...
    ContractType contractType = context.getCypCap().getInstance().getRawData().getContract(0)
        .getType();
    switch (contractType.getNumber()) {
      ...
      case ContractType.CreateSmartContract_VALUE:
        ...
        break;
      default:
        actuatorList = ActuatorCreator.getINSTANCE().createActuator(context.getCypCap());
    }
    if (actuator2 != null) {
