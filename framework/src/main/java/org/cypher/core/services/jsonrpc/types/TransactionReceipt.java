...
import static org.cypher.core.services.jsonrpc.JsonRpcApiUtil.convertToCypherAddress;
import static org.cypher.core.services.jsonrpc.JsonRpcApiUtil.getToAddress;
...
import org.cypher.protos.Protocol.ResourceReceipt;
...
public class TransactionReceipt {
  ...
  public TransactionReceipt(Protocol.Block block, TransactionInfo txInfo, Wallet wallet) {
    ...
    for (int index = 0; index < txInfo.getLogCount(); index++) {
      ...
      byte[] addressByte = convertToCypherAddress(log.getAddress().toByteArray());
