...
import org.cypher.common.entity.NodeInfo.ConfigNodeInfo;
import org.cypher.common.entity.NodeInfo.MachineInfo;
import org.cypher.common.entity.NodeInfo.MachineInfo.DeadLockThreadInfo;
import org.cypher.common.entity.NodeInfo.MachineInfo.MemoryDescInfo;
import org.cypher.common.entity.PeerInfo;
...
import org.cypher.core.services.WitnessProductBlockService.CheatWitnessInfo;
  ...
  private void setConnectInfo(NodeInfo nodeInfo) {
    ...
    for (PeerConnection peerConnection : syncPool.getActivePeers()) {
      ...
      ReasonCode reasonCode = peerConnection.getNodeStatistics()
          .getCypherLastLocalDisconnectReason();
      peerInfo.setLocalDisconnectReason(reasonCode == null ? "" : reasonCode.toString());
      reasonCode = peerConnection.getNodeStatistics().getCypherLastRemoteDisconnectReason();
