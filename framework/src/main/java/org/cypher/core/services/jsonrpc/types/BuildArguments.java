package org.cypher.core.services.jsonrpc.types;

import static org.cypher.core.services.jsonrpc.JsonRpcApiUtil.addressCompatibleToByteArray;
import static org.cypher.core.services.jsonrpc.JsonRpcApiUtil.paramQuantityIsNull;
import static org.cypher.core.services.jsonrpc.JsonRpcApiUtil.paramStringIsNull;
import static org.cypher.core.services.jsonrpc.JsonRpcApiUtil.parseQuantityValue;
  ...
  public ContractType getContractType(Wallet wallet) throws JsonRpcInvalidRequestException,
    ...
    if (paramStringIsNull(to)) {
      ...
      if (smartContract != null) {
        ...
        // tokenId and tokenValue: trc10, value: CYP
