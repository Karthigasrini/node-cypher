...
import org.cypher.core.services.ratelimiter.RateLimiterContainer;
import org.cypher.core.services.ratelimiter.RuntimeData;
import org.cypher.core.services.ratelimiter.adapter.DefaultBaseQqsAdapter;
import org.cypher.core.services.ratelimiter.adapter.GlobalPreemptibleAdapter;
import org.cypher.core.services.ratelimiter.adapter.IPQPSRateLimiterAdapter;
import org.cypher.core.services.ratelimiter.adapter.IPreemptibleRateLimiter;
import org.cypher.core.services.ratelimiter.adapter.IRateLimiter;
import org.cypher.core.services.ratelimiter.adapter.QpsRateLimiterAdapter;

@Slf4j
public abstract class RateLimiterServlet extends HttpServlet {

  private static final String KEY_PREFIX_HTTP = "http_";
  private static final String ADAPTER_PREFIX = "org.cypher.core.services.ratelimiter.adapter.";
