...
import org.cypher.core.services.http.GetAccountByIdServlet;
import org.cypher.core.services.http.GetAccountServlet;
import org.cypher.core.services.http.GetAssetIssueByIdServlet;
import org.cypher.core.services.http.GetAssetIssueByNameServlet;
import org.cypher.core.services.http.GetAssetIssueListByNameServlet;
import org.cypher.core.services.http.GetAssetIssueListServlet;
import org.cypher.core.services.http.GetBlockByIdServlet;
import org.cypher.core.services.http.GetBlockByLatestNumServlet;
import org.cypher.core.services.http.GetBlockByLimitNextServlet;
import org.cypher.core.services.http.GetBlockByNumServlet;
import org.cypher.core.services.http.GetBrokerageServlet;
import org.cypher.core.services.http.GetBurnCypServlet;
import org.cypher.core.services.http.GetDelegatedResourceAccountIndexServlet;
import org.cypher.core.services.http.GetDelegatedResourceServlet;
import org.cypher.core.services.http.GetExchangeByIdServlet;
import org.cypher.core.services.http.GetMarketOrderByAccountServlet;
import org.cypher.core.services.http.GetMarketOrderByIdServlet;
import org.cypher.core.services.http.GetMarketOrderListByPairServlet;
import org.cypher.core.services.http.GetMarketPairListServlet;
import org.cypher.core.services.http.GetMarketPriceByPairServlet;
import org.cypher.core.services.http.GetMerkleTreeVoucherInfoServlet;
import org.cypher.core.services.http.GetNodeInfoServlet;
import org.cypher.core.services.http.GetNowBlockServlet;
import org.cypher.core.services.http.GetPaginatedAssetIssueListServlet;
import org.cypher.core.services.http.GetRewardServlet;
import org.cypher.core.services.http.GetTransactionCountByBlockNumServlet;
import org.cypher.core.services.http.GetTransactionInfoByBlockNumServlet;
import org.cypher.core.services.http.IsShieldedTRC20ContractNoteSpentServlet;
import org.cypher.core.services.http.IsSpendServlet;
import org.cypher.core.services.http.ListExchangesServlet;
import org.cypher.core.services.http.ListWitnessesServlet;
import org.cypher.core.services.http.ScanAndMarkNoteByIvkServlet;
import org.cypher.core.services.http.ScanNoteByIvkServlet;
import org.cypher.core.services.http.ScanNoteByOvkServlet;
import org.cypher.core.services.http.ScanShieldedTRC20NotesByIvkServlet;
import org.cypher.core.services.http.ScanShieldedTRC20NotesByOvkServlet;
import org.cypher.core.services.http.TriggerConstantContractServlet;
...
public class SolidityNodeHttpApiService implements Service {
  ...
  public void start() {
    try {
      ...
      context.addServlet(new ServletHolder(getBurnCypServlet), "/walletsolidity/getburncyp");
