package org.cypher.core.services.ratelimiter;
...
import org.cypher.common.parameter.RateLimiterInitialization.RpcRateLimiterItem;
      ...
      try {
        ...
        switch (cName) {
          case "GlobalPreemptibleAdapter":
            cls = org.cypher.core.services.ratelimiter.adapter.GlobalPreemptibleAdapter.class;
            constructor = cls.getConstructor(String.class);
            obj = constructor.newInstance(params);
            container.add(KEY_PREFIX_RPC, component, (IRateLimiter) obj);
            break;
          case "QpsRateLimiterAdapter":
            cls = org.cypher.core.services.ratelimiter.adapter.QpsRateLimiterAdapter.class;
            constructor = cls.getConstructor(String.class);
            obj = constructor.newInstance(params);
            container.add(KEY_PREFIX_RPC, component, (IRateLimiter) obj);
            break;
          case "IPQPSRateLimiterAdapter":
            cls = org.cypher.core.services.ratelimiter.adapter.IPQPSRateLimiterAdapter.class;
            constructor = cls.getConstructor(String.class);
            obj = constructor.newInstance(params);
            container.add(KEY_PREFIX_RPC, component, (IRateLimiter) obj);
            break;
