...
import static org.cypher.core.config.Parameter.ChainConstant.BLOCK_PRODUCE_TIMEOUT_PERCENT;
import static org.cypher.core.config.Parameter.ChainConstant.MAX_ACTIVE_WITNESS_NUM;
...
import org.cypher.common.args.Account;
import org.cypher.common.args.GenesisBlock;
import org.cypher.common.args.Witness;
import org.cypher.common.config.DbBackupConfig;
import org.cypher.common.crypto.SignInterface;
import org.cypher.common.logsfilter.EventPluginConfig;
import org.cypher.common.logsfilter.FilterQuery;
import org.cypher.common.logsfilter.TriggerConfig;
...
import org.cypher.common.parameter.RateLimiterInitialization;
import org.cypher.common.setting.RocksDbSettings;
...
import org.cypher.common.utils.PropUtil;
...
import org.cypher.core.config.Parameter.NodeConstant;
...
public class Args extends CommonParameter {
  ...
  public static void clearParam() {
    ...
    PARAMETER.cypExpirationTimeInMilliseconds = 0;
  ...
  public static void setParam(final String[] args, final String confFileName) {
    ...
    PARAMETER.netMaxCypPerSecond = config.hasPath(Constant.NODE_NET_MAX_CYP_PER_SECOND)
        ? config.getInt(Constant.NODE_NET_MAX_CYP_PER_SECOND)
        : NetConstants.NET_MAX_CYP_PER_SECOND;
    ...
    PARAMETER.needToUpdateAsset =
        config.hasPath(Constant.STORAGE_NEEDTO_UPDATE_ASSET) ? config
            ...
            : true;
    PARAMETER.cypReferenceBlock = config.hasPath(Constant.CYP_REFERENCE_BLOCK)
        ? config.getString(Constant.CYP_REFERENCE_BLOCK) : "head";

    PARAMETER.cypExpirationTimeInMilliseconds =
        config.hasPath(Constant.CYP_EXPIRATION_TIME_IN_MILLIS_SECONDS)
            && config.getLong(Constant.CYP_EXPIRATION_TIME_IN_MILLIS_SECONDS) > 0
            ? config.getLong(Constant.CYP_EXPIRATION_TIME_IN_MILLIS_SECONDS)
    ...
    PARAMETER.cypCacheEnable = config.hasPath(Constant.NODE_RPC_CYP_CACHE_ENABLE)
            && config.getBoolean(Constant.NODE_RPC_CYP_CACHE_ENABLE);
