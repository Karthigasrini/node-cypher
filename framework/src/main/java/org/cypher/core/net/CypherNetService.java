...
import org.cypher.core.net.messagehandler.BlockMsgHandler;
import org.cypher.core.net.messagehandler.ChainInventoryMsgHandler;
import org.cypher.core.net.messagehandler.FetchInvDataMsgHandler;
import org.cypher.core.net.messagehandler.InventoryMsgHandler;
import org.cypher.core.net.messagehandler.PbftDataSyncHandler;
import org.cypher.core.net.messagehandler.SyncBlockChainMsgHandler;
import org.cypher.core.net.messagehandler.TransactionsMsgHandler;
import org.cypher.core.net.peer.PeerConnection;
import org.cypher.core.net.peer.PeerStatusCheck;
...
public class CypherNetService {
  ...
  public void start() {
    ...
    logger.info("CypherNetService start successfully.");
  }
  ...
  public void stop() {
    ...
    logger.info("CypherNetService closed successfully.");
  }
  ...
  protected void onMessage(PeerConnection peer, CypherMessage msg) {
    try {
      switch (msg.getType()) {
  ...
  private void processException(PeerConnection peer, CypherMessage msg, Exception ex) {
    ReasonCode code;
