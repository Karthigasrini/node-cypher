...
public class HttpTestAccount002 {
   ...
   * constructor.
   */
  @Test(enabled = true, description = "FreezeBlance for cypher power by http")
  public void test015FreezeCypherPower() {
    HttpMethed.waitToProduceOneBlock(httpnode);
    berforeBalance = HttpMethed.getBalance(httpnode, freezeBalanceAddress);
   ...
   * constructor.
   */
  @Test(enabled = true, description = "UnFreezeBalance for cypher power by http")
  public void test016UnFreezeBalanceForCypherPower() {
    berforeBalance = HttpMethed.getBalance(httpnode, freezeBalanceAddress);
