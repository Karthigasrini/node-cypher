...
public class NewFeatureForSolc080 {
  ...
  @Test(enabled = true, description = "transfer cyp to tx.origin address with payable")
  ...
  @Test(enabled = true, description = "transfer cyp to literal address with payable")
