...
import stest.cypher.wallet.common.client.utils.PublicMethedForMutiSign;
import stest.cypher.wallet.common.client.utils.Retry;
...
public class TransactionFee001 {
  ...
  Long beforeBurnCypAmount = 0L;
  Long afterBurnCypAmount = 0L;
  String txid = null;
  ...
  public void test01DeployContractEnergyFeeToSr() {
    ...
    beforeBurnCypAmount = blockingStubFull
        .getBurnCyp(EmptyMessage.newBuilder().build()).getNum();
    ...
    afterBurnCypAmount = blockingStubFull
        .getBurnCyp(EmptyMessage.newBuilder().build()).getNum();
    Assert.assertEquals(beforeBurnCypAmount,afterBurnCypAmount);
  }
  ...
  public void test02UpdateAccountPermissionAndMultiSiginTrans() {
    ...
    afterBurnCypAmount = blockingStubFull
        .getBurnCyp(EmptyMessage.newBuilder().build()).getNum();
    Assert.assertTrue(afterBurnCypAmount - beforeBurnCypAmount == 100000000L);
    ...
    afterBurnCypAmount = blockingStubFull
        .getBurnCyp(EmptyMessage.newBuilder().build()).getNum();
    Assert.assertTrue(afterBurnCypAmount - beforeBurnCypAmount == 1000000L);
  }
  ...
  public void test03OutOfTimeEnergyFeeToBlackHole() {
    ...
    afterBurnCypAmount = blockingStubFull
        .getBurnCyp(EmptyMessage.newBuilder().build()).getNum();
    Assert.assertTrue(afterBurnCypAmount - beforeBurnCypAmount == maxFeeLimit);
  }
  ...
  public void test04AccountCreate() {
    ...
    afterBurnCypAmount = blockingStubFull
        .getBurnCyp(EmptyMessage.newBuilder().build()).getNum();
    Assert.assertTrue(afterBurnCypAmount - beforeBurnCypAmount == 100000L);
  }
  ...
  public void test06CreateAssetIssue() {
    ...
    afterBurnCypAmount = blockingStubFull
        .getBurnCyp(EmptyMessage.newBuilder().build()).getNum();
    Assert.assertTrue(afterBurnCypAmount - beforeBurnCypAmount == 1024000000L);
  ...
  @Test(enabled = true, description = "Test getburncyp api from solidity or pbft")
  public void test07GetBurnCypFromSolidityOrPbft() {
    PublicMethed.waitSolidityNodeSynFullNodeData(blockingStubFull,blockingStubSolidity);
    Assert.assertEquals(blockingStubFull
        .getBurnCyp(EmptyMessage.newBuilder().build()),blockingStubSolidity.getBurnCyp(
        EmptyMessage.newBuilder().build()));
    Assert.assertEquals(blockingStubFull.getBurnCyp(EmptyMessage.newBuilder().build()),
        blockingStubPbft.getBurnCyp(
            EmptyMessage.newBuilder().build()));
  }
  /**
   * constructor.
