package stest.cypher.wallet.dailybuild.tvmnewcommand.create2;
...
public class Create2Test021 {
  ...
  public void test1TriggerContract() {
    ...
    //Trigger contract to transfer cyp and token.
  ...
  @Test(enabled = true, description = "Create2 contract can transfer cyp and token.")
