package stest.cypher.wallet.dailybuild.tvmnewcommand.transferfailed;

import static org.cypher.protos.Protocol.TransactionInfo.code.FAILED;
...
public class TransferFailed001 {
  ...
  @Test(enabled = true, description = "Transfer cyp insufficient balance")
  public void test001TransferCypInsufficientBalance() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "testTransferCypInsufficientBalance(uint256)", num, false,
  ...
  @Test(enabled = true, description = "Transfer cyp nonexistent target")
  public void test003TransferCypNonexistentTarget() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "testTransferCypNonexistentTarget(uint256,address)", num, false,
        0, maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);
  ...
  @Test(enabled = true, description = "Transfer cyp to myself")
  public void test004TransferCypSelf() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "testTransferCypSelf(uint256)", num, false,
        0, maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);
    ...
    Assert.assertEquals("transfer cyp failed: Cannot transfer CYP to yourself.",
        ByteArray.toStr(infoById.get().getResMessage().toByteArray()));
  ...
  @Test(enabled = true, description = "Transfer cyp nonexistent target and insufficient balance")
  public void test005TransferCypNonexistentTarget() {
  ...
  @Test(enabled = true, description = "Transfer cyp to myself and insufficient balance")
  public void test006TransferCypSelf() {
  ...
  @Test(enabled = true, description = "transferCyp to nonexistent target ,but revert")
  public void test010TransferRevert() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "testTransferCyprevert(uint256,address)", num, false,
        0, maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);
