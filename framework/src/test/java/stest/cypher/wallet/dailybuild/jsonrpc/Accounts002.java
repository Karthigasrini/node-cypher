package stest.cypher.wallet.dailybuild.jsonrpc;
...
import stest.cypher.wallet.common.client.utils.JsonRpcBase;
...
public class Accounts002 extends JsonRpcBase {
  ...
  @Test(enabled = true, description = "Json rpc api of eth_estimateGasSendCyp")
  public void test09JsonRpcApiTestForEthEstimateGasSendCyp() throws Exception {
    JsonObject param = new JsonObject();
    param.addProperty("from", ByteArray.toHexString(jsonRpcOwnerAddress));
  ...
  public void test34JsonRpcApiTestForWeb3ClientVersion() throws Exception {
    ...
    Assert.assertEquals(resultList.get(0), "CYPHER");
