package stest.cypher.wallet.dailybuild.tvmnewcommand.batchValidateSignContract;
...
public class batchValidateSignContract001 {
  ...
  public void test01Correct16signatures() {
    ...
    if (transactionExtention.getResult().getCode().toString().equals("CONTRACT_EXE_ERROR")) {
      Assert.assertEquals(
          "class org.cypher.core.vm.program.Program$OutOfTimeException "
  ...
  public void test02Incorrect1stSignatures() {
    ...
    if (transactionExtention.getResult().getCode().toString().equals("CONTRACT_EXE_ERROR")) {
      Assert.assertTrue(transactionExtention.getResult().getMessage().toStringUtf8().contains(
          "class org.cypher.core.vm.program.Program$OutOfTimeException : CPU timeout for"));
    } else {
