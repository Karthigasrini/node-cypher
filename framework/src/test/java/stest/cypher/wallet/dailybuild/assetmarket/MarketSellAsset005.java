package stest.cypher.wallet.dailybuild.assetmarket;
...
public class MarketSellAsset005 {
  ...
  byte [] cyp = ByteArray.fromString("_");
  ...
  @Test(enabled = true,description = "Create an order to sell Cyp and buy Trc10")
  void test01SellCypBuyTrc10() {
    ...
    String txid = PublicMethed.marketSellAsset(testAddress002,testKey002,cyp,
    ...
    txid = PublicMethed.marketSellAsset(testAddress001, testKey001, assetAccountId001,
            sellTokenQuantity * 2,
            cyp, buyTokenQuantity * 2, blockingStubFull);
  ...
  @Test(enabled = true,description = "Create an order to sell Trc10 and buy Cyp")
  void test02SellTrc10BuyCyp() {
    long balanceAfter = PublicMethed.queryAccount(testKey001, blockingStubFull).getBalance();
    ...
    txid = PublicMethed.marketSellAsset(testAddress001, testKey001, cyp,
            sellTokenQuantity * 2,
