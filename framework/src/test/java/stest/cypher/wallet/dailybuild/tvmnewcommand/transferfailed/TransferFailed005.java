...
public class TransferFailed005 {
  ...
  public void triggerContract01() {
    ...
    // transfer cyp to self`s account
    String param = "\"" + paramValue + "\",\"" + Base58.encode58Check(contractAddress) + "\"";
    String triggerTxid = PublicMethed
        .triggerContract(contractAddress, "testCallCypInsufficientBalance(uint256,address)", param,
    ...
    // transfer cyp to unactivate account
    ...
    // transfer cyp to caller, value enough , function success contractResult(call_value) successed
    ...
    // transfer cyp to caller, value not enough, function success
  ...
  public void triggerContract02() {
    ...
    String triggerTxid = PublicMethed
        .triggerContract(contractAddress, "testCreateCypInsufficientBalance(uint256)", param, false,
  ...
  public void triggerContract04() {
    ...
    TransactionExtention return1 = PublicMethed.triggerConstantContractForExtention(contractAddress,
        "testTransferCypInsufficientBalance(uint256)", "1", false, 0L, 1000000000, "0", 0L,
        accountExcAddress, accountExcKey, blockingStubFull);
    Assert.assertEquals(response_code.SUCCESS, return1.getResult().getCode());
    /*Assert.assertEquals(
        "class org.cypher.core.vm.program.Program$StaticCallModificationException "
