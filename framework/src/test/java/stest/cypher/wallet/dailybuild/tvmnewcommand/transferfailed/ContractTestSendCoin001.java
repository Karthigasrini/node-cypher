...
import static org.cypher.protos.Protocol.Transaction.Result.contractResult.SUCCESS_VALUE;
...
public class ContractTestSendCoin001 {
  ...
  public void testSendCoinAndTransferAssetContract001() {
    ...
    Assert.assertEquals("Contract validate error : Cannot transfer CYP to a smartContract.",
