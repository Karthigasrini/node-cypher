...
public class HttpTestMarket001 {
   ...
   * constructor.
   */
  @Test(enabled = true, description = "MarketSellAsset cyp with trc10 by http")
   ...
   * constructor.
   */
  @Test(enabled = true, description = "MarketCancelOrder cyp with trc10 by http")
