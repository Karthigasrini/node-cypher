...
public class WalletTestAssetIssue007 {
  ...
  private static final Integer cypNum = 1;
  ...
  public void testParticipateAssetIssueUseParticipateBandwidth() {
    ...
    Assert.assertTrue(PublicMethed
        .createAssetIssue(asset007Address, name, totalSupply, cypNum, icoNum, start, end, 1,
    ...
    Assert.assertTrue(beforeBalance - cypNum * 1 * icoNum >= afterBalance);
  }
