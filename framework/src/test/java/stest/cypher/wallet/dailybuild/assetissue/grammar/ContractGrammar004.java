package stest.cypher.wallet.dailybuild.assetissue.grammar;

import static org.cypher.protos.Protocol.Transaction.Result.contractResult.BAD_JUMP_DESTINATION_VALUE;
import static org.cypher.protos.Protocol.Transaction.Result.contractResult.OUT_OF_MEMORY_VALUE;
import static org.cypher.protos.Protocol.Transaction.Result.contractResult.OUT_OF_TIME_VALUE;
import static org.cypher.protos.Protocol.Transaction.Result.contractResult.REVERT_VALUE;
import static org.cypher.protos.Protocol.Transaction.Result.contractResult.STACK_TOO_LARGE_VALUE;
import static org.cypher.protos.Protocol.Transaction.Result.contractResult.STACK_TOO_SMALL_VALUE;
...
public class ContractGrammar004 {
  ...
  public void test8Grammar008() {
    ...
    txid = PublicMethed
        .triggerContract(contractAddress, "testTransferCypNonexistentTarget(uint256,address)", num,
    ...
    /*Assert.assertEquals(
        "transfer cyp failed: Validate InternalTransfer error, no ToAccount."
