...
import stest.cypher.wallet.common.client.utils.ShieldAddressInfo;
import stest.cypher.wallet.common.client.utils.ShieldNoteInfo;
...
public class HttpTestZenToken005 {
  ...
  public void test02GetMerkleTreeVoucherInfo() {
    HttpMethed.waitToProduceOneBlock(httpnode);
    response = HttpMethed
        .getMerkleTreeVoucherInfo(httpnode, sendNote.getCypId(), sendNote.getIndex(), 1);
    responseContent = HttpMethed.parseResponseContent(response);
    HttpMethed.printJsonContent(responseContent);
    ...
    response = HttpMethed
        .getMerkleTreeVoucherInfo(httpnode, receiveNote.getCypId(), receiveNote.getIndex(), 1000);
    responseContent = HttpMethed.parseResponseContent(response);
    HttpMethed.printJsonContent(responseContent);
  ...
  public void test03GetMerkleTreeVoucherInfoFromSolidity() {
    HttpMethed.waitToProduceOneBlock(httpnode);
    response = HttpMethed
        .getMerkleTreeVoucherInfoFromSolidity(httpSolidityNode, sendNote.getCypId(),
            sendNote.getIndex(), 1);
    responseContent = HttpMethed.parseResponseContent(response);
    HttpMethed.printJsonContent(responseContent);
    Assert.assertTrue(responseContent.toJSONString().contains("tree"));
    ...
    response = HttpMethed
        .getMerkleTreeVoucherInfoFromSolidity(httpSolidityNode, receiveNote.getCypId(),
