...
public class TransferFailed002 {
  ...
  public void test1SendNotEnough() {
    ...
    String num = "3000001";
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendCypInsufficientBalance(uint256)", num, false, 0,
  ...
  @Test(enabled = true, description = "Send cyp nonexistent target")
  public void test3SendCypNonexistentTarget() {
    ...
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendCypNonexistentTarget(uint256,address)", num,
  ...
  @Test(enabled = true, description = "Send cyp self")
  public void test4SendCypSelf() {
    Account info;
    ...
    String num = "1";
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendCypSelf(uint256)", num, false, 0, maxFeeLimit,
  ...
  @Test(enabled = true, description = "Send cyp nonexistent target and balance not enough")
  public void test5SendCypNonexistentTarget() {
    Account info;
  ...
  @Test(enabled = true, description = "Send cyp self and balance not enough")
  public void test6SendCypSelf() {
    Account info;
  ...
  @Test(enabled = true, description = "Send cyp nonexistent target, but revert")
  public void test7SendCypNonexistentTargetRevert() {
    ...
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendCypRevert(uint256,address)", num, false, 0,
            maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);
