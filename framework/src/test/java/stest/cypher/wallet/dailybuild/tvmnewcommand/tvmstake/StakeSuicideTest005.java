package stest.cypher.wallet.dailybuild.tvmnewcommand.tvmstake;
...
public class StakeSuicideTest005 {
  ...
  @Test(enabled = false, description = "targetAddress is account no CYP, and no frozen")
  ...
  @Test(enabled = false, description = "targetAddress is account 1 CYP, and no frozen")
  ...
  @Test(enabled = false, description = "targetAddress is account 1 CYP, and 1 frozen")
