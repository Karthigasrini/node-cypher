package stest.cypher.wallet.dailybuild.assetissue;
...
public class WalletTestAssetIssue005 {
  ...
  public void testGetAssetIssueByName() {
    ...
    Assert.assertTrue(assetIssueByName.getCypNum() > 0);
    ...
    Assert.assertFalse(assetIssueByName.getCypNum() > 0);
  ...
  public Boolean createAssetIssue(byte[] address, String name, Long totalSupply, Integer cypNum,
