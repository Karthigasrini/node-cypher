...
public class BuildTransaction001 extends JsonRpcBase {
  ...
  @Test(enabled = true, description = "Json rpc api of buildTransaction for transfer cyp")
  public void test01JsonRpcApiTestOfBuildTransactionForTransferCyp() throws Exception {
