...
public class StackSuicideTest001 {
  ...
  @Test(enabled = false, description = "targetAddress no CYP, and no frozen")
  ...
  @Test(enabled = false, description = "targetAddress has CYP, but no frozen")
  ...
  @Test(enabled = false, description = "targetAddress has CYP, and has frozen")
