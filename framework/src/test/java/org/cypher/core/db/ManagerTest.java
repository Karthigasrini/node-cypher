...
import static org.cypher.common.utils.Commons.adjustAssetBalanceV2;
import static org.cypher.common.utils.Commons.adjustBalance;
import static org.cypher.common.utils.Commons.adjustTotalShieldedPoolValue;
...
import org.cypher.protos.contract.AccountContract;
...
public class ManagerTest extends BlockGenerate {
  ...
  public void setBlockReference()
    ...
    TransferContract tc =
        TransferContract.newBuilder()
            ...
            .build();
    TransactionCapsule cyp = new TransactionCapsule(tc, ContractType.TransferContract);
    if (chainManager.getDynamicPropertiesStore().getLatestBlockHeaderNumber() == 0) {
      ...
      chainManager.setBlockReference(cyp);
      Assert.assertEquals(1,
          ByteArray.toInt(cyp.getInstance().getRawData().getRefBlockBytes().toByteArray()));
    }
  ...
  public void pushBlockInvalidMerkelRoot() {
    Transaction cyp = Transaction.newBuilder().build();
    TransactionCapsule moreTrans = new TransactionCapsule(cyp);
  ...
  public void pushBlockTooMuchShieldedTransactions() {
    ShieldContract.ShieldedTransferContract cyp1 = ShieldContract.ShieldedTransferContract
        .newBuilder()
        .setFromAmount(10)
        .setToAmount(10)
        .build();
    ShieldContract.ShieldedTransferContract cyp2 = ShieldContract.ShieldedTransferContract
        .newBuilder()
        .setFromAmount(20)
        .setToAmount(20)
        .build();
    TransactionCapsule trans1 = new TransactionCapsule(cyp1, ContractType.ShieldedTransferContract);
    TransactionCapsule trans2 = new TransactionCapsule(cyp2, ContractType.ShieldedTransferContract);
