...
import static stest.cypher.wallet.common.client.utils.PublicMethed.decode58Check;
...
public class WalletTest {
  ...
  private static void addTransactionInfoToStore(Transaction transaction) {
    ...
    byte[] cypId = transaction.getRawData().toByteArray();
    transactionInfo.setId(cypId);
    chainBaseManager.getTransactionHistoryStore().put(cypId, transactionInfo);
  }
