...
public class BandwidthProcessorTest {
  ...
  private static final int CYP_NUM = 2;
  ...
  public void testCreateNewAccount() throws Exception {
    ...
    TransactionCapsule cyp = new TransactionCapsule(transferAssetContract);
    ...
    org.cypher.protos.Protocol.Transaction.Contract contract =
        org.cypher.protos.Protocol.Transaction.Contract
            .newBuilder()
    ...
    long bytes = cyp.getSerializedSize();
    TransactionTrace trace = new TransactionTrace(cyp, StoreFactory
  ...
  public void testFree() throws Exception {
    ...
    TransactionCapsule cyp = new TransactionCapsule(contract);
    ...
    TransactionTrace trace = new TransactionTrace(cyp, StoreFactory
        .getInstance(), new RuntimeImpl());
    dbManager.consumeBandwidth(cyp, trace);
  ...
  public void sameTokenNameCloseConsumeSuccess() {
    ...
    long byteSize = cyp.getInstance().toBuilder().clearRet().build().getSerializedSize()
        + Constant.MAX_RESULT_SIZE_IN_TX;
  ...
  public void sameTokenNameCloseTransferToAccountNotExist() {
    ...
    TransactionCapsule cyp = new TransactionCapsule(contract, chainBaseManager.getAccountStore());
    TransactionTrace trace = new TransactionTrace(cyp, StoreFactory
        .getInstance(), new RuntimeImpl());
