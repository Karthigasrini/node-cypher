...
public class MarketSellAssetActuatorTest {
  ...
  private static final String CYP = "_";
  ...
  /**
   * no Enough Balance For Selling CYP, result is failed, exception is "No enough balance !".
   */
  @Test
  public void noEnoughBalanceForSellingCYP() {
  ...
  /**
   * no buy orders before,add first sell order,selling CYP and buying token
   */
  @Test
  ...
  /**
   * no buy orders before,add first sell order,selling Token and buying CYP
   */
  @Test
