...
import static org.cypher.core.net.message.MessageTypes.P2P_DISCONNECT;
import static org.cypher.core.net.message.MessageTypes.P2P_HELLO;
import static org.cypher.protos.Protocol.ReasonCode.DUPLICATE_PEER;
import static org.cypher.protos.Protocol.ReasonCode.FORKED;
import static org.cypher.protos.Protocol.ReasonCode.INCOMPATIBLE_CHAIN;
import static org.cypher.protos.Protocol.ReasonCode.INCOMPATIBLE_VERSION;
...
import org.cypher.common.overlay.message.HelloMessage;
import org.cypher.common.overlay.message.Message;
import org.cypher.common.overlay.message.P2pMessage;
import org.cypher.common.overlay.message.P2pMessageFactory;
...
public class TcpTest {
  ...
  public TcpTest(CypherApplicationContext context) {
    channelManager = context.getBean(ChannelManager.class);
    manager = context.getBean(Manager.class);
    chainBaseManager = context.getBean(ChainBaseManager.class);
    pool = context.getBean(SyncPool.class);
    tronNetDelegate = context.getBean(CypherNetDelegate.class);
  }
