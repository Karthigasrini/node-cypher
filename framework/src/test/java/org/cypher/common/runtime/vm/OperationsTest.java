...
public class OperationsTest {
  ...
  private Program buildEmptyContext(byte[] ops) {
    Program context = new Program(
        ...
        new InternalTransaction(
            ...
            InternalTransaction.CypType.CYP_UNKNOWN_TYPE));
  ...
  public void testArithmeticOperations() throws ContractValidateException {
    ...
    Protocol.Transaction cyp = Protocol.Transaction.getDefaultInstance();
    InternalTransaction interCyp =
        new InternalTransaction(cyp, InternalTransaction.CypType.CYP_UNKNOWN_TYPE);
  ...
  public void testMemoryStorageAndFlowOperations() throws ContractValidateException {
    ...
    program = new Program(compile(
        "PUSH1 0x01 PUSH1 0x05 JUMPI JUMPDEST PUSH1 0xCC"), invoke, interCyp);
  ...
  public void testPushDupSwapAndLogOperations() throws ContractValidateException {
    ...
    program = new Program(compile(
        "PUSH2 0x1234 PUSH1 0x00 MSTORE PUSH1 0x20 PUSH1 0x00 LOG0"), invoke, interCyp);
    testSingleOperation(program);
    testSingleOperation(program);
    testSingleOperation(program);
    testSingleOperation(program);
    ...
    program = new Program(compile("PUSH2 0x1234 PUSH1 0x00 MSTORE PUSH2 0x9999"
        + " PUSH2 0x6666 PUSH2 0x3333 PUSH1 0x20 PUSH1 0x00 LOG3"), invoke, interCyp);
    testSingleOperation(program);
    testSingleOperation(program);
    testSingleOperation(program);
    testSingleOperation(program);
    ...
    program = new Program(compile("PUSH2 0x1234 PUSH1 0x00 MSTORE PUSH2 0x9999 PUSH2"
        + " 0x6666 PUSH2 0x3333 PUSH2 0x5555 PUSH1 0x20 PUSH1 0x00 LOG4"), invoke, interCyp);
    testSingleOperation(program);
    testSingleOperation(program);
    testSingleOperation(program);
    testSingleOperation(program);
