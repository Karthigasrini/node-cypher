...
import org.cypher.core.actuator.FreezeBalanceActuator;
...
import org.cypher.core.vm.PrecompiledContracts.PrecompiledContract;
...
public class PrecompiledContractsTest {
  ...
  private PrecompiledContract createPrecompiledContract(DataWord addr, String ownerAddress) {
    ...
    contract.setCallerAddress(convertToCypherAddress(Hex.decode(ownerAddress)));
