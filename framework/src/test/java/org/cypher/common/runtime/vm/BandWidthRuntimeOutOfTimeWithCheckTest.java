...
public class BandWidthRuntimeOutOfTimeWithCheckTest {
  ...
  private String cyp2ContractAddress = "TPMBUANrTwwQAPwShn7ZZjTJz1f3F8jknj";
  ...
  public void testSuccess() {
    try {
      ...
      TransactionCapsule cypCap = new TransactionCapsule(transaction);
      cypCap.setResultCode(contractResult.OUT_OF_ENERGY);
      TransactionTrace trace = new TransactionTrace(cypCap, StoreFactory.getInstance(),
          new RuntimeImpl());
      dbManager.consumeBandwidth(cypCap, trace);
