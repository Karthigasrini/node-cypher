...
public class DepositTest {
  ...
  public void loopCallTest()
    ...
    Runtime runtime = TvmTestUtils
        .processTransactionAndReturnRuntime(aCyp, DepositImpl.createRoot(manager),
            null);
    ...
    byte[] aAddress = WalletUtil.generateContractAddress(aCyp);
    byte[] bAddress = WalletUtil.generateContractAddress(bCyp);
  ...
  public void loopCallTestOldVersion()
    ...
    Runtime runtime = TvmTestUtils.processTransactionAndReturnRuntime(aCyp, rootDeposit,
        null);
    Assert.assertNull(runtime.getRuntimeError());
    ...
    Transaction bCyp = TvmTestUtils.generateDeploySmartContractAndGetTransaction(
        ...
        null);
    rootDeposit = DepositImpl.createRoot(manager);
    runtime = TvmTestUtils.processTransactionAndReturnRuntime(bCyp, rootDeposit, null);
    Assert.assertNull(runtime.getRuntimeError());
