...
public class TvmTestUtils {
  ...
  public static byte[] deployContractWholeProcessReturnContractAddress(String contractName,
    ...
    Transaction cyp = generateDeploySmartContractAndGetTransaction(contractName, callerAddress, abi,
        code, value, feeLimit, consumeUserResourcePercent, libraryAddressPair);
    processTransactionAndReturnRuntime(cyp, deposit, block);
    return WalletUtil.generateContractAddress(cyp);
  }
  ...
  public static Runtime triggerContractWholeProcessReturnContractAddress(byte[] callerAddress,
      ...
      throws ContractExeException, ReceiptCheckErrException,
      ContractValidateException, VMIllegalException {
    Transaction cyp = generateTriggerSmartContractAndGetTransaction(callerAddress, contractAddress,
        data, callValue, feeLimit);
    return processTransactionAndReturnRuntime(cyp, deposit, block);
  }
  ...
  public static Transaction generateDeploySmartContractAndGetTransaction(String contractName,
    ...
    TransactionCapsule cypCapWithoutFeeLimit = new TransactionCapsule(contract,
        ContractType.CreateSmartContract);
    Transaction.Builder transactionBuilder = cypCapWithoutFeeLimit.getInstance().toBuilder();

    Transaction.raw.Builder rawBuilder = cypCapWithoutFeeLimit.getInstance().getRawData()
        .toBuilder();
    rawBuilder.setFeeLimit(feeLimit);
    transactionBuilder.setRawData(rawBuilder);
    Transaction cyp = transactionBuilder.build();
    return cyp;
  }
  ...
  public static Runtime processTransactionAndReturnRuntime(Transaction cyp,
  ...
  public static TransactionTrace processTransactionAndReturnTrace(Transaction cyp,
  ...
  public static TVMTestResult deployContractAndReturnTvmTestResult(String contractName,
    ...
    return processTransactionAndReturnTvmTestResult(cyp, dbManager, blockCap)
        .setContractAddress(WalletUtil.generateContractAddress(cyp));
  }
  ...
  public static TVMTestResult deployContractWithCreatorEnergyLimitAndReturnTvmTestResult(
      ...
      throws ContractExeException, ReceiptCheckErrException,
      ContractValidateException, VMIllegalException {
    Transaction cyp = generateDeploySmartContractWithCreatorEnergyLimitAndGetTransaction(
  ...
  public static TVMTestResult processTransactionAndReturnTvmTestResult(Transaction cyp,
