package org.cypher.common.parameter;
...
import org.cypher.core.config.args.Overlay;
import org.cypher.core.config.args.SeedNode;
import org.cypher.core.config.args.Storage;
...
public class CommonParameter {
  ...
  @Parameter(names = {"--contract-parse-enable"},
      description = "enable contract parses in java-cypher or not.(true or false)")
  ...
  //If you are running a solidity node for java cypher, this flag is set to true
  @Getter
  @Setter
  ...
  @Getter
  @Setter
  public long netMaxCypPerSecond;
  @Getter
  @Setter
  ...
  @Getter
  @Setter
  public String cypReferenceBlock;
  @Getter
  @Setter
  public int minEffectiveConnection;
  @Getter
  @Setter
  public boolean cypCacheEnable;
  @Getter
  @Setter
  ...
  @Getter
  @Setter
  public long cypExpirationTimeInMilliseconds; // (ms)
