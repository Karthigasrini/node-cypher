...
public class Constant {
  ...
  public static final long SUN_PER_ENERGY = 100; // 1 us = 100 SUN = 100 * 10^-6 CYP
  ...
  public static final byte[] ZCYPHER_EXPANDSEED_PERSONALIZATION = {'Z', 't', 'r', 'o', 'n', '_', 'E',
      'x',
      'p', 'a', 'n', 'd', 'S', 'e', 'e', 'd'};
  ...
  public static final String NODE_NET_MAX_CYP_PER_SECOND = "node.netMaxCypPerSecond";
  ...
  public static final String CYP_REFERENCE_BLOCK = "cyp.reference.block";

  public static final String CYP_EXPIRATION_TIME_IN_MILLIS_SECONDS = "cyp.expiration.timeInMilliseconds";

  public static final String NODE_RPC_MIN_EFFECTIVE_CONNECTION = "node.rpc.minEffectiveConnection";

  public static final String NODE_RPC_CYP_CACHE_ENABLE = "node.rpc.cypCacheEnable";
