...
import org.cypher.core.capsule.MarketPriceCapsule;
...
public class MarketUtils {
  ...
  /**
   * ex.
   * for sellToken is A, buyToken is CYP.
   * price_A_maker * sellQuantity_maker = Price_CYP * buyQuantity_maker
   * ==> price_A_maker = Price_CYP * buyQuantity_maker/sellQuantity_maker
   *
  ...
  public static boolean priceMatch(MarketPrice takerPrice, MarketPrice makerPrice) {
    ...
    // price_A_taker * buyQuantity_taker = Price_CYP * sellQuantity_taker
    // ==> price_A_taker = Price_CYP * sellQuantity_taker/buyQuantity_taker

    // price_A_taker must be greater or equal to price_A_maker
    // price_A_taker / price_A_maker >= 1
    // ==> Price_CYP * sellQuantity_taker/buyQuantity_taker >= Price_CYP * buyQuantity_maker/sellQuantity_maker
