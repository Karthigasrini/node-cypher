...
import static org.cypher.common.utils.Commons.ASSET_ISSUE_COUNT_LIMIT_MAX;
...
@Slf4j(topic = "DB")
@Component
public class AssetIssueStore extends CypherStoreWithRevoking<AssetIssueCapsule> {
