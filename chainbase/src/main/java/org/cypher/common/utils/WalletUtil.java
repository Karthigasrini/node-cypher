...
import org.cypher.protos.contract.SmartContractOuterClass.SmartContract.ABI.Entry.StateMutabilityType;
...
public class WalletUtil {
  ...
  public static byte[] generateContractAddress(Transaction cyp) {
    ...
    byte[] txRawDataHash = cypCap.getTransactionId().getBytes();
